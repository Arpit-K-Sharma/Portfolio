...
function SignInForm() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-background-secondary">
            <div className="max-w-md w-full mx-4">
                <div className="card text-center">
                    ...
                    <div className="mt-8 pt-6 border-t border-border">
                        <Link href="/" className="text-foreground-muted hover:text-foreground text-sm">
                            ← Back to Home
                        </Link>
                    </div>
                </div>
